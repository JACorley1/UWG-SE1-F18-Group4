 ...
 * 
 * @author Tyler Scott, Nolan Williams, Dexter Tarver
 * 
 */
public class EventDataValidator {
	 ...
	 * This is used when displaying user warning when creating events starting in
	 * the past.
	 * 
	...
	/**
	 * Checks the end time, determining if it is after the current start time. This
	 * is used when displaying user warning when creating events starting in the
	 * past.
	 * 
